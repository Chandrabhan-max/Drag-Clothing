...
const ManagerInventory = () => {
  ...
  // productId -> number of low stock variants
  const [productLowStockCounts, setProductLowStockCounts] =
    useState({});
  ...
  // =========================================================
  // FETCH VARIANTS FOR LOW STOCK ALERT
  // =========================================================

  const getProductLowStockCount = async (
    productId
  ) => {
    if (!productId) {
      return 0;
  ...
  // =========================================================
  // FETCH PRODUCTS + IMAGES + STOCK ALERTS
  // =========================================================
  ...
  const fetchProducts = async () => {
    try {
      ...
      // -------------------------------------------------------
      // FETCH IMAGES + LOW STOCK COUNT FOR EVERY PRODUCT
      // -------------------------------------------------------
  ...
  // =========================================================
  // FETCH SELECTED PRODUCT VARIANTS
  // =========================================================
  ...
  const fetchVariants = async (
    ...
    try {
      ...
      // -------------------------------------------------------
      // UPDATE LOW STOCK COUNT FOR SELECTED PRODUCT
      // -------------------------------------------------------
      ...
      console.error(
        '❌ Fetch manager product variants failed:',
        err?.response?.data || err
      );
  ...
  // =========================================================
  // CURRENT PRODUCT LOW STOCK COUNT
  // =========================================================
          ...
          >
            ...
            {filteredProducts.map(
              (product) => {
                ...
                // IMPORTANT:
                // This is the product-level alert.
