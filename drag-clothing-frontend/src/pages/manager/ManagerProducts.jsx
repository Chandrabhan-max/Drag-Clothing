...
const ManagerProducts = () => {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      // Fetch first image for every product
        ...
        productData.map(async (product) => {
          ...
          try {
            ...
            return {
              ...
              // Keep multiple formats so UI works
              imageUrl: firstImage,
  ...
  const handleStatusToggle = async (
    ...
    try {
      await api.patch(
        `/manager/products/${productId}/live`,
        {
          isActive: status,
        }
      );
  ...
  const handleHardDelete = async () => {
    ...
    try {
      ...
      alert(
        error?.response?.data?.message ||
        'Cannot delete product linked to existing orders or variants.'
      );
    } finally {
      setIsLoading(false);
    }
...
/* =========================================================
   ...
   Keeps JSX clean without adding variant logic.
========================================================= */
